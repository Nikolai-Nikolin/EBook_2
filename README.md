...
### 5. Регистрация и авторизация работника
1. С логина и пароля работника регистрируем в системе
2. После этого для него генерируется токен (JWT), по которому он сможет зайти в систему и выполнять свои обязанности (в зависимости от его роли в системе)
...
### service
Содержит функции для получения хешированного пароля работника и для поиска его в системе

### utils
Содержит функцию для создания захешироанного пароля 
...
![Screenshot 2024-02-05 204750.png](image%2FScreenshot%202024-02-05%20204750.png)
